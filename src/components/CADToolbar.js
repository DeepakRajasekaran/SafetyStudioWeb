...
import {
  SelectionPlus, Hammer, Subtract, LineSegment, Rectangle, Circle as CircleIcon, Ruler,
  ArrowUUpLeft, Trash, GpsFix, Equals, ArrowUp, ArrowRight, Rows, VectorTwo, Anchor, ChartPieSlice, Angle
...
const CADToolbar = ({
  ...
  return (
    <div style={{ display: 'flex', gap: 5, background: '#222', padding: '2px 8px', borderRadius: 6, alignItems: 'center' }}>
      ...
      <button onClick={() => setActiveTool('sector')} title="Sector (Pie Slice)"
