...
function solveIteration(particles) {
    ...
    const targetAx = midX - targetXX * len2 / 2, targetAy = midY - targetYY * len2 / 2;
    const targetBx = midX + targetXX * len2 / 2, targetBy = midY + targetYY * len2 / 2;
    
    a2.x += (targetAx - a2.x) * STEP; a2.y += (targetAy - a2.y) * STEP;
    b2.x += (targetBx - b2.x) * STEP; b2.y += (targetBy - b2.y) * STEP;
